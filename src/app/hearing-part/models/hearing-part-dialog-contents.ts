...
export const HEARING_PART_ASSIGN_CANCELLED = 'The hearing part cannot be assigned because one of the engaged' +
    ' entities is already being modified by someone else. Please try again later';

export const HEARING_PART_DIALOGS = {
    [TransactionStatuses.CANCELLED]: HEARING_PART_ASSIGN_CANCELLED
}